...
export const ny21 = [
  { month: "JAN", date: "DATE HOLD", anchor: "MLK / WINTER OPEN" },
  { month: "FEB", date: "DATE HOLD", anchor: "POST-SUPER BOWL / ALL-STAR" },
  { month: "MAR", date: "DATE HOLD", anchor: "SPRING KICKOFF" },
  { month: "APR", date: "DATE HOLD", anchor: "SPRING" },
  { month: "MAY", date: "DATE HOLD", anchor: "MEMORIAL DAY WINDOW" },
  { month: "JUN", date: "DATE HOLD", anchor: "EARLY SUMMER" },
  { month: "JUL", date: "DATE HOLD", anchor: "SUMMER" },
  { month: "AUG", date: "DATE HOLD", anchor: "LATE SUMMER" },
  { month: "SEP", date: "DATE HOLD", anchor: "LABOR DAY / FALL OPEN" },
  { month: "OCT", date: "DATE HOLD", anchor: "HOMECOMING SEASON" },
  { month: "NOV", date: "DATE HOLD", anchor: "FALL" },
  { month: "DEC", date: "DATE HOLD", anchor: "HOLIDAY CONCERT" },
];

export const ny30 = [
  { month: "JAN", date: "DATE HOLD", anchor: "NEW YEAR / WINTER" },
  { month: "FEB", date: "DATE HOLD", anchor: "VALENTINE'S R&B" },
  { month: "MAR", date: "DATE HOLD", anchor: "SPRING" },
  { month: "APR", date: "DATE HOLD", anchor: "SPRING" },
  { month: "MAY", date: "DATE HOLD", anchor: "MOTHER'S DAY WINDOW" },
  { month: "JUN", date: "DATE HOLD", anchor: "JUNETEENTH WINDOW" },
  { month: "JUL", date: "DATE HOLD", anchor: "SUMMER" },
  { month: "AUG", date: "DATE HOLD", anchor: "LATE SUMMER" },
  { month: "SEP", date: "DATE HOLD", anchor: "FALL OPEN" },
  { month: "OCT", date: "DATE HOLD", anchor: "HOMECOMING SEASON" },
  { month: "NOV", date: "DATE HOLD", anchor: "THANKSGIVING WINDOW" },
  { month: "DEC", date: "DATE HOLD", anchor: "HOLIDAY R&B" },
];
