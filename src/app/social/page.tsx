...
export default function SocialPage(){return <PlatformShell>
  <Hero visual={MASTER} visualPosition="center 45%" eyebrow="ICONIC SOCIAL™" title="THE RIGHT ROOM CHANGES WHAT HAPPENS NEXT." sub="Invite-level power networking for creators, operators, brands and cultural tastemakers — curated for real connection without conference energy." visualNote="CURATED PEOPLE · CULTURAL CAPITAL · REAL CONNECTION" />
