...
export default function SocialPage(){return <PlatformShell><main className="cp-page">
  <section className="cp-graphic-hero" style={{background:`linear-gradient(90deg,rgba(8,8,8,.94),rgba(8,8,8,.42)),url(${ART.runway}) center/cover no-repeat`}}><div><div className="cp-kicker">ICONIC SOCIAL™</div><h1>THE RIGHT ROOM CHANGES WHAT HAPPENS NEXT.</h1><p>Invite-level power networking for creators, operators, brands and cultural tastemakers — curated for real connection without conference energy.</p></div></section>
