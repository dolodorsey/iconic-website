  ...
  <Section eyebrow="Access" title="Tickets are live. Premium and partner lanes stay separate.">
    <EventActionCenter
      ...
      actions={[
        ...
        {key:"giveaway",eyebrow:"Official Giveaway",title:"Win Your Way In.",body:"Enter the controlled Nightmare giveaway hub for ticket, merch and approved experience drops. No purchase necessary; entries remain locked until the official compliance gate opens.",href:"/tampa/nightmare-on-channelside/giveaways",cta:"Open Giveaway Hub"},
