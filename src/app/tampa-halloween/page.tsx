...
export default function TampaHalloweenPage(){
  return <LivePropertyPage
    ...
    stats={[
      ...
      {label:"Access",value:"Tickets + VIP",body:"Presale, premium hospitality and final event details now flow through a direct intake system."},
    ...
    primaryHref="/access?intent=presale&property=tampa-halloween"
    secondaryLabel="Sponsor Tampa"
    secondaryHref="/access?intent=sponsorship&property=tampa-halloween"
